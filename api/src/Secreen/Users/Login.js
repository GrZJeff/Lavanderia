        ...
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={handleSubmit} style={styles.primaryBtn}>
                    <Text style={styles.primaryBtnText}>Inicia Sesión</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => navigation.navigate('Crear Usuario')} style={styles.secondaryBtn}>
                    <Text style={styles.secondaryBtnText}>¿Aún no tienes cuenta?</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Actualizar Usuario')} style={styles.navBtn}>
                    <Text style={styles.navBtnText}>Actualizar Usuario</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    );
